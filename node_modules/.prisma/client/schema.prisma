...
model krathong {
  ...
  t_id     Int
  kt_type  kt_type   @relation(fields: [t_id], references: [t_id])
  history  history[]
...
model person {
  ...
  role_id     Int
  ct_id       Int
  country     country     @relation(fields: [ct_id], references: [ct_id])
  person_role person_role @relation(fields: [role_id], references: [role_id])
  history     history[]
